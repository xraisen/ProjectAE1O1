...
;(() => {
  ...
  const DEFAULT_CONFIG = {
    apiUrl:
      "https://script.google.com/macros/s/AKfycbx33uAHz5Yuxki29KSqYqy7uWTv850Jp8IsGQevsbKyjNKcWj9N3suuUOkdXxr0E-fV/exec", // Google Apps Script URL
    primaryColor: "#e91e63",
    textColor: "#ffffff",
  ...
  function sendMessage(customMessage = null) {
    ...
    setTimeout(() => {
      if (window[callbackName]) {
        ...
        document.head.removeChild(script)
        hideTypingIndicator()
        addErrorMessage("Request timed out. Please try again.", message)
      }
    }, config.apiTimeout)
  }
