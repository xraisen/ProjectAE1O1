...
;(() => {
  ...
  const DEFAULT_CONFIG = {
    apiUrl: "https://script.google.com/macros/s/AKfycbys0cIz4SYCFS3h7xue2TFPHBe8RiT94Bbgb0Gg0sg4fJF4OY-NoLUiCfxcvIFuStrS/exec", // Replace with your actual backend URL
    primaryColor: "#e91e63",
    textColor: "#ffffff",
  ...
  function createWidget() {
    ...
    headerTitle.innerHTML = `${getIconSvg("message-circle")} <span>Store Assistant</span>`
